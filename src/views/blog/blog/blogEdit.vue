...
<script>
  ...
  import {getBlogEditReturn} from "../../../api/blog"
  export default {
    name: "blogEdit",
    props: ["blogId"],
    data() {
    ...
    methods: {
      ...
      , onSubmit() {
        editBlog(this.BlogUploadParam).then(res => {
          console.log(res)
          this.$message.success("成功修改博客")
          this.BlogUploadParam={}
          this.$emit("closeEditDialog", false);
        })
      }
    ...
    mounted() {
      getBlogEditReturn(this.$props.blogId).then(res=>{
        this.BlogUploadParam.id=res.data.blogEditReturn.blogId
        this.BlogUploadParam.title=res.data.blogEditReturn.blogTitle
        this.BlogUploadParam.blogImage=res.data.blogEditReturn.blogImage
        this.BlogUploadParam.blogContent=res.data.blogEditReturn.blogContent
        this.BlogUploadParam.blogRemark=res.data.blogEditReturn.blogRemark
      })
    }
  }
</script>
